...
//結果輸出值填寫在這
var chart_1_y = [
  15,30,50,90,20,15,30,50,10,20,30,54
];
var chart_2_y = [
  80, 65, 65, 40, 55, 34, 54, 50, 60, 64, 55, 27
];
var chart_3_val = 33;
var chart_4_val = 10;
...
drawCircle('#chart-3',1,chart_3_val,'#circle-1');
drawCircle('#chart-4',2,chart_4_val,'#circle-2');
